...
const osSemaphoreAttr_t wifiContinueSem_attributes = {
  .name = "wifiContinueSem"
};
/* USER CODE BEGIN PV */
bool done = false;
uint8_t buffer[1] = { 0 };
...
int main(void)
{
  ...
  /* creation of wifiContinueSem */
  wifiContinueSemHandle = osSemaphoreNew(1, 1, &wifiContinueSem_attributes);
  ...
  commandTaskHandle = osThreadNew(StartCmdTask, NULL, &commandTask_attributes);
